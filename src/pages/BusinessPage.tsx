...
export function BusinessPage({ onNavigate }: BusinessPageProps) {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Diferenciá tu edificio u oficina con tecnología de vanguardia",
    },
    {
      icon: <CheckCircle2 className="w-6 h-6" />,
    ...
    },
    {
      ...
      description:
        "Equipo técnico disponible para mantenimiento y actualizaciones",
    },
  ];
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            >
              <div>
                ...
                >
                  <p>
                    Ofrecemos diferentes esquemas de partnership según el tipo
                    de espacio y el nivel de involucramiento deseado.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-6 h-6 text-[#FF6B00] flex-shrink-0 mt-0.5" />
                      <span>
                        <strong>Modelo concesión:</strong> Instalamos, operamos
                        y compartimos ingresos
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-6 h-6 text-[#FF6B00] flex-shrink-0 mt-0.5" />
                      <span>
                        <strong>Licencia de marca:</strong> Proveemos tecnología
                        y know-how para operación propia
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="w-6 h-6 text-[#FF6B00] flex-shrink-0 mt-0.5" />
                      <span>
                        <strong>Servicio white label:</strong> Adaptamos la
                        plataforma a tu marca institucional
                      </span>
                    </li>
                  </ul>
                  <p className="pt-4">
                    Cada implementación es única y diseñada para maximizar el
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "0.875rem", opacity: 0.9 }}>
                        Ya operamos en edificios premium con alta densidad de
                        usuarios
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "0.875rem", opacity: 0.9 }}>
                        Desarrollamos y mantenemos toda la infraestructura
                        digital
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "0.875rem", opacity: 0.9 }}>
                        Profesionales con años de experiencia en retail,
        ...
        <section className="py-20 bg-gradient-to-br from-[#FF6B00] to-[#ff8533] text-white">
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            >
              ...
              >
                Nuestro compromiso es escalar un modelo que genere valor
                sostenible para usuarios, propietarios y la comunidad,
                posicionando a Argentina como referente en retail tech de última
                generación.
              </p>
              <div className="mt-12">
                <Button
